...
const linkAction=()=>{
    const navMenu= document.getElementById('nav-menu')
    // when we click on each navLink, we remove the showe mwnu
    navMenu.classList.remove('show-menu')
}
...
const shadowHeader = () =>{
    ...
    //add a class if the bottom offset is greater than 50 of 
...
sr.reveal('.home__dish',{delay:1200,distance:'100px',duration:1500})
